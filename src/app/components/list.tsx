                    ...
                    <tr>
                        ...
                        <td>
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <div className="text-base-200/80 font-bold">Gender Equality</div>
                                    <div className="text-base-200/50">Equality org</div>
                                </div>
                            </div>
                        </td>
                        <td className="text-base-200/80">
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <div className="text-base-200/80 font-bold">Disabilities Association</div>
                                    <div className="text-base-200/50">Time to break obstacles</div>
                                </div>
                            </div>
                        </td>
                        <td className="text-base-200/80">
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <div className="text-base-200/80 font-bold">Library and intelligence classes</div>
                                    <div className="text-base-200/50">Educate Org</div>
                                </div>
                            </div>
                        </td>
                        <td className="text-base-200/80">
                            Socialization is a lifelong process that starts from the birth. In this process, school and primarily the family play an important role. Playing mind games and reading book are among key issues that influence positively the development of intelligence, learning new things and getting socialize in terms of children.          
                            <br />
                            <span className="badge badge-ghost badge-sm bg-accent border-accent">Buy a ticket for $5</span>
                        </td>
